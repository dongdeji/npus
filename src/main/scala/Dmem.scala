...
class Dmem(ClusterId:Int, GroupId:Int, NpId: Int)(implicit p: Parameters) extends Module with NpusParams 
{
    ...
    io.core.resp.valid := req_valid_s1 && dramaddress.contains(req_addr_s1)
