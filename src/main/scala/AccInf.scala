      ...
      switch(state_R(tid)) 
      {
        ...
        { 
          ...
          { // to do 
            ...
            accouts(tid).aw.bits.addr := 
                MuxLookup(accMeta_R(tid).req.uop.rs1, lramBase.U(addrWidth.W),
                                Seq(  0.U -> tcamBase.U(addrWidth.W),
                                      1.U -> lramBase.U(addrWidth.W),
                                      2.U -> eamBase.U(addrWidth.W))).asUInt
